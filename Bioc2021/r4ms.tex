    ...
    \begin{column}{.38\textwidth}
      ...
      \begin{block}{}
        ...
        \begin{itemize}
          ...
          \item Christophe Vanderaa's workshop where he demonstrates
            the \bpkg{QFeatures} (and \bpkg{scp}) packages to process
            and analyse single-cell proteomics data.

          \item Johannes Rainer's workshop that shows how to use the
            \bpkg{Spectra} package for seamless processing of raw mass
            spectrometry data.

          \item Meet us at the \textit{Bioconducor Mass Spectrometry}
            table in the lounge.
